...
describe("MockedCall()", () => {
    describe("setup:", () => {
        ...
        it("After timesAtMost()", () => {
            ...
            assertThat(mockedCall.describe()).is({
                ...
                expectedTimes: {"number.lessEqual": 5}, passed: true
            });
        });
        ...
        it("Multiple arguments with timesAtLeast(2)", () => {
            ...
            assertThat(mockedCall.describe()).is({
                ...
                expectedTimes: {"number.greaterEqual": 2}, passed: false
            });
        });
    });
    ...
    describe("didRun()", () => {
        ...
        it("Suceeds on first call but not second", () => {
            ...
            assertThat(mockedCall.describe()).is({
                name: "thespian.m()", expectedArgs: [7],
                expectedTimes: 1,
                passed: true
            });
            assertThat(successfulCalls).is([
                {name: "thespian.m()", actualArgs: [7], returnValue: 3, expectedTime: 1}
            ]);
        });
    });
});
