...
describe("MockedCall()", () => {
    it("initially", () => {
        ...
        assertThat(mockedCall.describe()).is({
            methodOrFunction: "thespian.m()", expectedArgs: [1],
            expectedTimes: 1,
            passed: false,
            successfulCalls: []
        });
    ...
    it("After returns()", () => {
        ...
        assertThat(mockedCall.describe()).is({
            methodOrFunction: "thespian.m()", expectedArgs: [1],
            expectedTimes: 1, passed: false, successfulCalls: []
        });
    });
    ...
    it("After times()", () => {
        ...
        assertThat(mockedCall.describe()).is({
            methodOrFunction: "thespian.m()", expectedArgs: [1],
            expectedTimes: 5, passed: false, successfulCalls: []
        });
    });
    ...
    it("After timesAtMost()", () => {
        const mockedCall = new MockedCall("thespian", "m", ["a"])
            .timesAtMost(5);
        assertThat(mockedCall.describe()).is({
            methodOrFunction: 'thespian.m()', expectedArgs: ["a"],
            expectedTimes: {"number.lessEqual": 5}, passed: true, successfulCalls: []
        });
    });
    ...
    it("Multiple arguments with timesAtLeast(2)", () => {
        const mockedCall = new MockedCall("thespian", "m", [1, "a", true])
            .timesAtLeast(2);
        assertThat(mockedCall.describe()).is({
            methodOrFunction: 'thespian.m()', expectedArgs: [1, "a", true],
            expectedTimes: {"number.greaterEqual": 2}, passed: false, successfulCalls: []
        });
    });
    ...
    describe("didRun()", () => {
        ...
        it("Suceeds on first call but not second", () => {
            ...
            assertThat(mockedCall.describe()).is({
                methodOrFunction: "thespian.m()", expectedArgs: [7],
                expectedTimes: 1,
                passed: true,
